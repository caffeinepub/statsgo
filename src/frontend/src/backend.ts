...
export class Backend implements backendInterface {
    ...
    async createStat(arg0: string, arg1: bigint): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createStat(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async deleteStat(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteStat(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getStatsSortedByTimestamp(): Promise<Array<Stat>> {
        if (this.processError) {
            try {
                const result = await this.actor.getStatsSortedByTimestamp();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateStat(arg0: bigint, arg1: string | null, arg2: bigint | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateStat(arg0, to_candid_opt_n1(this._uploadFile, this._downloadFile, arg1), to_candid_opt_n2(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
